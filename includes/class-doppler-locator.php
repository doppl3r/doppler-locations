...
class Doppler_Locator {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Doppler_Locator_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $doppler_locator    The string used to uniquely identify this plugin.
	 */
	...
	public function __construct() {
		if ( defined( 'DOPPLER_LOCATORVERSION' ) ) {
			$this->version = DOPPLER_LOCATORVERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Doppler_Locator_Loader. Orchestrates the hooks of the plugin.
	 * - Doppler_Locator_i18n. Defines internationalization functionality.
	 * - Doppler_Locator_Admin. Defines all hooks for the admin area.
	 * - Doppler_Locator_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Doppler_Locator_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Doppler_Locator_Loader    Orchestrates the hooks of the plugin.
	 */
